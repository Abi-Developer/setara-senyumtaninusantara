...
(() => {
  ...
  if (requestForm) {
    requestForm.addEventListener("submit", (event) => {
      ...
      if (requestNote) requestNote.textContent = "Mengirim permintaan…";
...
(() => {
  ...
  const en = {
    ...
    "about.story.p1": "SETARA introduces the richness of Indonesian coffee through carefully selected green beans. We build relationships that grow together with farmers, processing partners, and international buyers.",
    ...
    "index.stats.tons.number": "Based on Customer Demand",
